...
const DAYS_AGO = 18; // Number of days to go back.
...
(async () => {
  ...
  for (i = 0; i < DAYS_AGO; i++) { // Exclude today.
    ...
    csvStream.write({ Tarih: date.format('DD.MM.YYYY'), VefatSayisi2020: count2020, VefatSayisi2019: count2019, VefatSayisi2018: count2018 });
